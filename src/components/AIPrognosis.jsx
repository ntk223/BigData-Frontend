...
function AIPrognosis({ isPredicting, readmissionResult, mortalityResult }) {
  ...
  //             </span>
  //             <p className="ai-desc">
  //               Độ tin cậy của thuật toán: <b>{(readmissionResult.confidence * 100).toFixed(1)}%</b>. 
  ...
  //             </span>
  //             <p className="ai-desc">
  //               Thời gian sống thêm trung bình (RMST 12m): <b>{mortalityResult.rmst_12m.toFixed(1)} ngày</b>. 
